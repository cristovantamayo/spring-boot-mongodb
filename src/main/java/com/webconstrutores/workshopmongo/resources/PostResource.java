...
import com.webconstrutores.workshopmongo.resources.util.URL;
import com.webconstrutores.workshopmongo.services.PostService;
...
public class PostResource {
	...
	private ResponseEntity<List<Post>> findByTitle( @RequestParam(value="text", defaultValue = "") String text) {
		List<Post> posts = service.fincByTitle(URL.decodeParam(text));
